...
BEGIN
    EXECUTE IMMEDIATE 'DROP TABLE Resenias CASCADE CONSTRAINTS';
    ...
    EXECUTE IMMEDIATE 'DROP TABLE Especialidades CASCADE CONSTRAINTS';
    EXECUTE IMMEDIATE 'DROP TABLE Disponibilidades CASCADE CONSTRAINTS';
